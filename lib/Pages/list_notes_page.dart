...
import 'package:notes/Service/notes_services.dart';
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => AddNotesPage(note: notes[index])));
                        },
                        child: Container(
                          margin: EdgeInsets.only(top: (index == 0) ? 10 : 5, bottom: (index ==notes.length-1)?30:0),
                          child: Center(
                            child: Card(
                              child: Container(
                                width:
                                ...
                                child: ListTile(
                                  ...
                                  trailing: GestureDetector(
                                    onTap: ()async{
                                      await NotesServices.deleteNote(notes[index].id);
                                      setState(() {
